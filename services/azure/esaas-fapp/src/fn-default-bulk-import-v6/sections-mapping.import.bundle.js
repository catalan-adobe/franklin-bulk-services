        ...
        if (parseInt(esaasImpId.slice(-1), 10) % 2 === 0) {
          ...
          if (headerEl == null ? void 0 : headerEl.div) {
            const headerBlock = headerParser(headerEl.div, {
              ...
              bodyW: (_a = predictedBoxes[0]) == null ? void 0 : _a.width
            });
          ...
          elsToRemove.concat(
            predictedBoxes.filter((s) => {
              var _a2, _b;
              return ((_a2 = s.prediction) == null ? void 0 : _a2.sectionType) === "header" || ((_b = s.prediction) == null ? void 0 : _b.sectionType) === "footer";
