...
export async function main(context, req) {
    ...
    if (req.method === 'POST') {
         ...
         * ],                             // (required) array of URLs to import
         * "target": "esaas",             // (optional) "esaas" or "lpb"
         * "username": "john.doe",        // (optional) username
         * "enforceCustomBlockName": true // (optional) true|false enforce custom block name
         */
        try {
            ...
            urls = urls.map((url, idx) => {
                ...
                u.searchParams.set('ecbn', req.body?.enforceCustomBlockName || 'false');
